...
<span style="background-color:#D48686; color:white; padding:2px 4px; border-radius:3px; font-weight:bold;">IEEE TKDE</span> [ADEdgeDrop: Adversarial Edge Dropping for Robust Graph Neural Networks]() <br />
...
<span style="background-color:#628FC6; color:white; padding:2px 4px; border-radius:3px; font-weight:bold;">IJCAI 2025</span> [Divide and Conquer: Coordinating Multiplex Mixture of Graph Learners to Handle Multi-Omics Analysis]() <br />
...
<span style="background-color:#628FC6; color:white; padding:2px 4px; border-radius:3px; font-weight:bold;">IJCAI 2025</span> [A Centrality-based Graph Learning Framework]() <br />
Jiajun Yu<sup>†</sup>, **Zhihao Wu<sup>†</sup>**, Jielong Lu, Tianyue Wang, Haishuai Wang <br />
*International Joint Conference on Artificial Intelligence 2025* \|  [\[BibTex\]]()
<br />

<span style="background-color:#628FC6; color:white; padding:2px 4px; border-radius:3px; font-weight:bold;">IJCAI 2025</span> [Multi-Omics Analysis for Cancer Subtype Inference via Unrolling Graph Smoothness Priors]() <br />
...
<span style="background-color:#628FC6; color:white; padding:2px 4px; border-radius:3px; font-weight:bold;">NeurIPS 2023</span> [Graph Convolutional Kernel versus Graph Convolutional Networks](https://proceedings.neurips.cc/paper_files/paper/2023/file/3ec6c6fc9065aa57785eb05dffe7c3db-Paper-Conference.pdf) <br />
...
<span style="background-color:#D48686; color:white; padding:2px 4px; border-radius:3px; font-weight:bold;">IEEE TMM</span> [Interpretable Graph Convolutional Network for Multi-View Semi-Supervised Learning](IMVGCN-TMM2023.pdf) <br />
...
<span style="background-color:#628FC6; color:white; padding:2px 4px; border-radius:3px; font-weight:bold;">KDD 2025</span> [MSHTrans: Multi-Scale Hypergraph Transformer with Time-Series Decomposition for Temporal Anomaly Detection]() <br />
...
<span style="background-color:#D48686; color:white; padding:2px 4px; border-radius:3px; font-weight:bold;">INFORM FUSION</span> [Dissecting vulnerability in information fusion process of graph convolutional networks](https://www.sciencedirect.com/science/article/abs/pii/S1566253525006086) <br />
...
<span style="background-color:#628FC6; color:white; padding:2px 4px; border-radius:3px; font-weight:bold;">IJCAI 2025</span> [Strategy-Architecture Synergy: A Multi-View Graph Contrastive Paradigm for Consistent Representations]() <br />
Shuman Zhuang, **Zhihao Wu**, Yuhong Chen, Zihan Fang, Jiali Yin, Ximeng Liu <br />
*International Joint Conference on Artificial Intelligence 2025* \|  [\[BibTex\]]()
<br />

<span style="background-color:#628FC6; color:white; padding:2px 4px; border-radius:3px; font-weight:bold;">AAAI 2023</span> [Dual Low-Rank Graph Autoencoder for Semantic and Topological Networks](DLRGAE_AAAI2023.pdf) <br />Zhaoliang Chen, **Zhihao Wu**, Shiping Wang, Wenzhong Guo <br />
...
<span style="background-color:#628FC6; color:white; padding:2px 4px; border-radius:3px; font-weight:bold;">AAAI 2023</span> [Beyond Graph Convolutional Network: An Interpretable Regularizer-Centered Optimization Framework](tsGCN-AAAI2023.pdf) <br />
...
<span style="background-color:#628FC6; color:white; padding:2px 4px; border-radius:3px; font-weight:bold;">ACM MM 2024</span> [Towards Multi-view Consistent Graph Diffusion](https://dl.acm.org/doi/pdf/10.1145/3664647.3681258) <br />
...
<span style="background-color:#D48686; color:white; padding:2px 4px; border-radius:3px; font-weight:bold;">IEEE TNNLS</span> [AGNN: Alternating Graph-Regularized Neural Networks to Alleviate Over-Smoothing](AGNN2023.pdf) <br />
...
<span style="background-color:#D48686; color:white; padding:2px 4px; border-radius:3px; font-weight:bold;">NEUNET</span> [Attributed Multi-order Graph Convolutional Network for Heterogeneous Graphs](https://www.sciencedirect.com/science/article/abs/pii/S0893608024001497) <br />
...
<span style="background-color:#D48686; color:white; padding:2px 4px; border-radius:3px; font-weight:bold;">IEEE TMM</span> [Generative Essential Graph Convolutional Network for Multi-view Semi-supervised Classification](https://ieeexplore.ieee.org/abstract/document/10462517/) <br />
...
<span style="background-color:#628FC6; color:white; padding:2px 4px; border-radius:3px; font-weight:bold;">AAAI 2025</span> [Mixture of Experts as Representation Learner for Deep Multi-view Clustering](https://ojs.aaai.org/index.php/AAAI/article/view/34430) <br />
...
<span style="background-color:#628FC6; color:white; padding:2px 4px; border-radius:3px; font-weight:bold;">ACM MM 2024</span> [Enhancing Multi-view Graph Neural Network with Cross-view Confluent Message Passing](https://dl.acm.org/doi/pdf/10.1145/3664647.3681585) <br />
